...
struct GpuSuperclusterNbListNeighborhoodBuilder
{
          ...
          Tnc* nc) const
    {
        ...
        std::size_t neighborDataSize =
            buildNbList<Config>(exec, tree, box, totalBodies, groups, x, y, z, h, nc, firstValidBody, numISuperclusters,
                                jClusterBboxes.get(), nodeRMaxData, ncmax, neighborData.get(), neighborDataVirtualSize,
