...
class DiskVeProp : public HydroVeProp<false, DomainType, DataType>
{
protected:
    using Base = HydroVeProp<false, DomainType, DataType>;
    using Base::timer;

    using T = typename DataType::RealType;

public:
    DiskVeProp(std::ostream& output, size_t rank, const InitSettings& settings)
        : Base(output, rank)
    {
    }
