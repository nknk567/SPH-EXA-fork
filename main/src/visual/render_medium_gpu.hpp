...
extern void computeTileListGPU(size_t startIndex, size_t endIndex, const T* x, const T* y, const T* z, const Th* h,
...
extern void renderMediumGPU(size_t startIndex, size_t endIndex, const Ta* a, const T* x, const T* y, const T* z,
                            const Th* h, const Tm* m, const Trho* rho, const Grid& g, const Twh* wh, T K,
                            double* pixels, size_t* tile_offsets, size_t* tile_lists);
